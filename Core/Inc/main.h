...
#define ACCEL_RAMP_STEP_RPM ACCEL_RAMP_STEP_RPM_DEFAULT
#define ACCEL_RAMP_PERIOD_MS ACCEL_RAMP_PERIOD_MS_DEFAULT

#define DECEL_RAMP_STEP_RPM  DECEL_RAMP_STEP_RPM_DEFAULT
